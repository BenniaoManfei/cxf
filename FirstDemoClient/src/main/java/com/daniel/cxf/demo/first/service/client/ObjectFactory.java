 ...
 * generated in the com.daniel.cxf.demo.first.service.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetCatsByUserResponse_QNAME = new QName("http://cxf.service.first.demo.cxf.daniel.com/", "getCatsByUserResponse");
    private final static QName _SayHiResponse_QNAME = new QName("http://cxf.service.first.demo.cxf.daniel.com/", "sayHiResponse");
    private final static QName _SayHi_QNAME = new QName("http://cxf.service.first.demo.cxf.daniel.com/", "sayHi");
    private final static QName _GetCatsByUser_QNAME = new QName("http://cxf.service.first.demo.cxf.daniel.com/", "getCatsByUser");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.daniel.cxf.demo.first.service.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.service.first.demo.cxf.daniel.com/", name = "getCatsByUserResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.service.first.demo.cxf.daniel.com/", name = "sayHiResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.service.first.demo.cxf.daniel.com/", name = "sayHi")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.service.first.demo.cxf.daniel.com/", name = "getCatsByUser")
